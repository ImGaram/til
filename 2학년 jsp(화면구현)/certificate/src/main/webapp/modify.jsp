...
<script type="text/javascript" src="check.js"></script>
	...
	<form method="post" name="frm" action="action.jsp" style="display: flex; justify-content: center; align-items: center; text-align: center">
		...
		<table border="1">
			...
			<tr>
				...
				<select name="lecturer" style="width: 100%">
					...
					<option value="4"> <% if(lecturer.equals("4")) out.println("selected"); %> 무교수 </option>
				</select>
				</td>
			</tr>
			<tr>
				...
				<input type="radio" name="week" value="2" <% if(week.equals("2")) out.println("checked"); %>> 수
				<input type="radio" name="week" value="3" <% if(week.equals("3")) out.println("checked"); %>> 금
				</td>
			</tr>
			<tr>
				<td>시작시간</td>
