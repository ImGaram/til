...
try {
	...
	sql = "select distinct a.menuno, a.menuname, sum(b.amount), a.price*sum(b.amount) from menu_tbl a, order_tbl b where a.menuno = b.menuno group by a.menuno, a.menuname, a.price order by a.menuno";
